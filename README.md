...
```javascript
import SmartlyWebSocket from 'smartly-websocket';

const rws = new SmartlyWebSocket('ws://my.site.com');
...
const rws = new SmartlyWebSocket(urlProvider);
```
...
const rws = new SmartlyWebSocket('ws://my.site.com', [], options);
```
